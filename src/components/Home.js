...
function Home() {
  ...
  return (
    <div style={{ fontFamily: font, background: '#f8f9fa', minHeight: '100vh', overflowX: 'hidden' }}>

      {/* ===== HERO SECTION ===== */}
      <div style={{ background: 'linear-gradient(135deg, #0a0f1a 0%, #1a1a2e 30%, #16213e 60%, #0f3460 100%)', color: '#fff', padding: '70px 20px 50px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        {/* Decorative circles */}
        <div style={{ position: 'absolute', top: -80, right: -80, width: 250, height: 250, borderRadius: '50%', background: 'rgba(233,69,96,0.08)' }} />
        <div style={{ position: 'absolute', bottom: -60, left: -60, width: 200, height: 200, borderRadius: '50%', background: 'rgba(15,52,96,0.3)' }} />

        <div style={{ position: 'relative', zIndex: 1 }}>
          {/* Teacher Photo */}
          <div style={{ width: 170, height: 170, borderRadius: '50%', overflow: 'hidden', margin: '0 auto 20px', border: '4px solid rgba(233,69,96,0.5)', boxShadow: '0 8px 40px rgba(0,0,0,0.4), 0 0 0 8px rgba(255,255,255,0.05)' }}>
            <img src={process.env.PUBLIC_URL + '/images/logo.png'} alt="Ms. Sismar" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
          </div>

          <h1 style={{ fontSize: 34, fontWeight: 800, margin: '0 0 6px', letterSpacing: 0.5 }}>Marie Michelle L. Sismar</h1>
          <p style={{ fontSize: 15, opacity: 0.85, margin: '0 0 4px', fontWeight: 300 }}>Licensed Professional Teacher</p>
          <p style={{ fontSize: 14, opacity: 0.7, margin: '0 0 16px', fontWeight: 300 }}>Libertad National High School, Butuan City</p>

          {/* School Badge */}
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 10, background: 'rgba(255,255,255,0.08)', backdropFilter: 'blur(10px)', borderRadius: 24, padding: '8px 20px', border: '1px solid rgba(255,255,255,0.1)' }}>
            <img src={process.env.PUBLIC_URL + '/images/michelle.jpg'} alt="LNHS" style={{ width: 30, height: 30, borderRadius: '50%' }} />
            <span style={{ fontSize: 13, fontWeight: 400 }}>Department of Education &mdash; Division of Butuan City</span>
          </div>
        </div>
      </div>

      {/* ===== STATS BAR ===== */}
      <div style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: 0, background: 'linear-gradient(90deg, #0f3460, #1a1a2e)', padding: 0, color: '#fff' }}>
        {[
          ...
          <div key={s.label} style={{ textAlign: 'center', flex: '1 1 140px', padding: '24px 16px', borderRight: '1px solid rgba(255,255,255,0.06)' }}>
            ...
            <div style={{ fontSize: 11, opacity: 0.6, marginTop: 4, textTransform: 'uppercase', letterSpacing: 1.5, fontWeight: 500 }}>{s.label}</div>
          </div>
        ))}
      </div>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '50px 20px 10px' }}>
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <h2 style={{ fontSize: 28, fontWeight: 700, color: '#1a1a2e', margin: '0 0 16px' }}>Shaping Futures, One Student at a Time</h2>
      ...
      <div style={{ maxWidth: 960, margin: '0 auto', padding: '10px 20px 50px' }}>
        <div style={{ textAlign: 'center', marginBottom: 30 }}>
          ...
          <h2 style={{ fontSize: 26, fontWeight: 700, color: '#1a1a2e', margin: 0 }}>About the Teacher</h2>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 20, justifyContent: 'center' }}>
          {[
            ...
            <div key={c.title} style={{ flex: '1 1 260px', maxWidth: 300, background: '#fff', borderRadius: 14, padding: '28px 24px', boxShadow: '0 4px 20px rgba(0,0,0,0.06)', border: '1px solid #f0f0f0', transition: 'transform 0.2s' }}>
              ...
              <div style={{ fontSize: 16, fontWeight: 600, color: '#1a1a2e', marginBottom: 8 }}>{c.title}</div>
      ...
      <div style={{ background: '#fff', padding: '50px 20px' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 30 }}>
            ...
            <h2 style={{ fontSize: 26, fontWeight: 700, color: '#1a1a2e', margin: 0 }}>Subjects Handled</h2>
            <div style={{ width: 50, height: 3, background: '#e94560', margin: '12px auto 0', borderRadius: 2 }} />
          </div>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 14, justifyContent: 'center' }}>
            {[
              ...
              <div key={sub.name} style={{ background: 'linear-gradient(135deg, #1a1a2e, #0f3460)', color: '#fff', borderRadius: 12, padding: '16px 22px', minWidth: 150, textAlign: 'center', fontSize: 13.5, fontWeight: 500, display: 'flex', alignItems: 'center', gap: 10, boxShadow: '0 4px 15px rgba(15,52,96,0.3)' }}>
      ...
      <div style={{ maxWidth: 960, margin: '0 auto', padding: '50px 20px' }}>
        <div style={{ textAlign: 'center', marginBottom: 30 }}>
          ...
          <h2 style={{ fontSize: 26, fontWeight: 700, color: '#1a1a2e', margin: 0 }}>Advisory Sections</h2>
          <div style={{ width: 50, height: 3, background: '#e94560', margin: '12px auto 0', borderRadius: 2 }} />
        </div>
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 16, justifyContent: 'center' }}>
          {[
            ...
            <div key={cls.section} style={{ flex: '1 1 170px', maxWidth: 200, background: '#fff', borderRadius: 12, padding: '20px 16px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)', border: '1px solid #f0f0f0', textAlign: 'center', borderTop: '3px solid ' + cls.color }}>
              ...
              <div style={{ fontSize: 13.5, fontWeight: 600, color: '#1a1a2e', marginBottom: 4 }}>{cls.section}</div>
      ...
      <div style={{ background: '#fff', padding: '50px 20px' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 30 }}>
            ...
            <h2 style={{ fontSize: 26, fontWeight: 700, color: '#1a1a2e', margin: 0 }}>Announcements</h2>
            <div style={{ width: 50, height: 3, background: '#e94560', margin: '12px auto 0', borderRadius: 2 }} />
          </div>
            ...
            {[
              ...
              <div key={a.title} style={{ display: 'flex', gap: 16, background: '#fafbfc', borderRadius: 12, padding: '20px 24px', border: '1px solid #f0f0f0', alignItems: 'flex-start' }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: 15, fontWeight: 600, color: '#1a1a2e', marginBottom: 6 }}>{a.title}</div>
      ...
      <div style={{ maxWidth: 960, margin: '0 auto', padding: '50px 20px' }}>
        <div style={{ textAlign: 'center', marginBottom: 30 }}>
          ...
          <h2 style={{ fontSize: 26, fontWeight: 700, color: '#1a1a2e', margin: 0 }}>Vision &amp; Mission</h2>
          <div style={{ width: 50, height: 3, background: '#e94560', margin: '12px auto 0', borderRadius: 2 }} />
        </div>
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 20, justifyContent: 'center' }}>
          <div style={{ flex: '1 1 320px', maxWidth: 440, background: 'linear-gradient(135deg, #1a1a2e, #0f3460)', borderRadius: 16, padding: '32px 28px', color: '#fff', boxShadow: '0 8px 30px rgba(15,52,96,0.3)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
              <i className="fas fa-eye" style={{ fontSize: 22, color: '#e94560' }} />
              <h3 style={{ fontSize: 20, fontWeight: 700, margin: 0 }}>Vision</h3>
            </div>
            <p style={{ fontSize: 14, lineHeight: 1.8, opacity: 0.85, margin: 0 }}>
              We dream of Filipinos who passionately love their country and whose values and competencies enable them to realize their full potential and contribute meaningfully to building the nation.
            </p>
          </div>
          <div style={{ flex: '1 1 320px', maxWidth: 440, background: 'linear-gradient(135deg, #1a1a2e, #0f3460)', borderRadius: 16, padding: '32px 28px', color: '#fff', boxShadow: '0 8px 30px rgba(15,52,96,0.3)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
              <i className="fas fa-bullseye" style={{ fontSize: 22, color: '#e94560' }} />
        ...
        <div style={{ marginTop: 20 }}>
          <div style={{ background: '#fff', borderRadius: 16, padding: '28px', boxShadow: '0 4px 20px rgba(0,0,0,0.06)', border: '1px solid #f0f0f0' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
              ...
              <h3 style={{ fontSize: 18, fontWeight: 700, margin: 0, color: '#1a1a2e' }}>Core Values</h3>
            </div>
      ...
      <div style={{ background: '#fff', padding: '50px 20px' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 30 }}>
            ...
            <h2 style={{ fontSize: 26, fontWeight: 700, color: '#1a1a2e', margin: 0 }}>Quick Links</h2>
            <div style={{ width: 50, height: 3, background: '#e94560', margin: '12px auto 0', borderRadius: 2 }} />
          </div>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 16, justifyContent: 'center' }}>
            {[
              ...
              <div key={link.label} style={{ flex: '1 1 180px', maxWidth: 210, background: '#fafbfc', borderRadius: 12, padding: '22px 18px', textAlign: 'center', border: '1px solid #f0f0f0', cursor: 'pointer' }}>
                ...
                <div style={{ fontSize: 14, fontWeight: 600, color: '#1a1a2e', marginBottom: 4 }}>{link.label}</div>
      ...
      {/* ===== CONTACT SECTION ===== */}
      <div style={{ background: 'linear-gradient(135deg, #f0f4f8, #e8eef5)', padding: '50px 20px' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', textAlign: 'center' }}>
          ...
          <h2 style={{ fontSize: 26, fontWeight: 700, color: '#1a1a2e', margin: '0 0 12px' }}>Contact Information</h2>
      ...
      {/* ===== FOOTER ===== */}
      <div style={{ background: '#0a0f1a', color: 'rgba(255,255,255,0.5)', textAlign: 'center', padding: '28px 20px', fontSize: 12, borderTop: '3px solid #e94560' }}>
        <div style={{ marginBottom: 10 }}>
          <i className="fas fa-graduation-cap" style={{ color: '#e94560', marginRight: 8 }} />
          <span style={{ fontWeight: 600, color: 'rgba(255,255,255,0.7)' }}>Teacher Portal</span>
